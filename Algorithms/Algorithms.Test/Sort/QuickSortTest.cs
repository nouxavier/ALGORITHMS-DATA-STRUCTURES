...
namespace Algorithms.Test.Sort
{
    public class QuickSortTest
    {
        ...
        [Fact]
        public void SortListAlternativeConvertSuccess()
        {
            var input = new int[] { 0, 3, 1, 1 };
            Assert.Equal(new int[] { 1, 1, 1, 2, 3 }, QuickSortBuilder.NewAllProps(input).ConvertListIndex(input.ToList()));
        }
